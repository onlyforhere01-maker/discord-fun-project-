...
import { PlaygroundPanels } from './PlaygroundPanels.js'
import { PlaygroundTheme } from './PlaygroundTheme.js'
...
export class Game
{
    ...
    async init()
    {
        ...
        this.playgroundPanels = new PlaygroundPanels()
        this.playgroundTheme = new PlaygroundTheme()
        this.menu = new Menu()
