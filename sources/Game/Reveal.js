...
import { PlaygroundSignage } from './PlaygroundSignage.js'
...
export class Reveal
{
    ...
    updateStep(step)
    {
        ...
        else if(step === 1)
        {
            ...
            // Failsafe if GSAP onComplete does not run
            gsap.delayedCall(3 / speedMultiplier, () =>
            {
                if(this.step === 1)
                    this.finishReveal()
            })
        ...
        else if(step === 2)
        {
            ...
            PlaygroundSignage.applySafe(this.game)
